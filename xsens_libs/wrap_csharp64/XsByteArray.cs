...
public class XsByteArray : XsByteArrayImpl {
  ...
  internal XsByteArray(IntPtr cPtr, bool cMemoryOwn) : base(xsensdeviceapiPINVOKE.XsByteArray_SWIGUpcast(cPtr), cMemoryOwn) {
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsByteArray obj) {
  ...
  public SWIGTYPE_p_unsigned_char data() {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsByteArray_data__SWIG_0(swigCPtr);
