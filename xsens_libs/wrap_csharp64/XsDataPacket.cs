...
public class XsDataPacket : IDisposable {
  ...
  public void swapMessage(XsMessage msg) {
    xsensdeviceapiPINVOKE.XsDataPacket_swapMessage(swigCPtr, XsMessage.getCPtr(msg));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public XsVector convertRawVector(XsUShortVector input) {
    XsVector ret = new XsVector(xsensdeviceapiPINVOKE.XsDataPacket_convertRawVector__SWIG_0(swigCPtr, XsUShortVector.getCPtr(input)), true);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static XsVector convertRawVector(XsUShortVector input, XsDataIdentifier id) {
    XsVector ret = new XsVector(xsensdeviceapiPINVOKE.XsDataPacket_convertRawVector__SWIG_1(XsUShortVector.getCPtr(input), (int)id), true);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
