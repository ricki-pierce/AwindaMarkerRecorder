...
public class XsSyncSettingArrayImpl : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsSyncSettingArrayImpl(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsSyncSettingArrayImpl obj) {
