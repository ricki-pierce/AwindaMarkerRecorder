...
public class XsEuler : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsEuler(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsEuler obj) {
  ...
  public SWIGTYPE_p_double data() {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsEuler_data(swigCPtr);
