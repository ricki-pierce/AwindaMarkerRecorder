...
public class XsMessageArrayImpl : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsMessageArrayImpl(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsMessageArrayImpl obj) {
