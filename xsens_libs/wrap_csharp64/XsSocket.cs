...
public class XsSocket : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsSocket(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsSocket obj) {
  ...
  public uint nativeDescriptor() {
    uint ret = xsensdeviceapiPINVOKE.XsSocket_nativeDescriptor(swigCPtr);
    return ret;
  }
  ...
  public SWIGTYPE_p_XsSocket accept(int mstimeout) {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsSocket_accept__SWIG_0(swigCPtr, mstimeout);
    SWIGTYPE_p_XsSocket ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_XsSocket(cPtr, false);
    return ret;
  }

  public SWIGTYPE_p_XsSocket accept() {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsSocket_accept__SWIG_1(swigCPtr);
    SWIGTYPE_p_XsSocket ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_XsSocket(cPtr, false);
    return ret;
  }
