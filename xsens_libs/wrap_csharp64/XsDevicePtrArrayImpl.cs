...
public class XsDevicePtrArrayImpl : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsDevicePtrArrayImpl(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsDevicePtrArrayImpl obj) {
  ...
  public SWIGTYPE_p_XsDevice at(uint index) {
    IntPtr cPtr = xsensdeviceapiPINVOKE.XsDevicePtrArrayImpl_at__SWIG_0(swigCPtr, index);
