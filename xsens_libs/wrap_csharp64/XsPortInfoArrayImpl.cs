...
public class XsPortInfoArrayImpl : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal XsPortInfoArrayImpl(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(XsPortInfoArrayImpl obj) {
